<template>
    <div id="note-page-comment">
        <section class="ouvJEz">
            ...
            <div class="_26JdYM">
                <!-- 用户头像展示位置 -->
                <img class="_3LHFA-" src="http://qzapp.qlogo.cn/qzapp/100410602/9C15C6F8B2408C836063FDBBA72B92DC/100" alt="">
                <div class="_3GKFE3">
                    <textarea class="_1u_H4i" placeholder="说点什么吧..."></textarea>

                    <div class="_3IXP9Q" style="display: flex;">
                        <div class="SKZUyR"><span>⌘ + Return 发表</span></div>
                        <div class="_3Tp4of">
            ...
            <div class="_2gPNSa">
                <div class="_2IUqvs _3uuww8" id="comment-50817634">
                    <a class="_1OhGeD" href="/u/a203a1fc243f" target="_blank" rel="noopener noreferrer">
                        <img class="_1_jhXc" src="http://qzapp.qlogo.cn/qzapp/100410602/9C15C6F8B2408C836063FDBBA72B92DC/100" alt="">
                    </a>
                    <div class="_1K9gkf">
                        <div class="_23G05g">
                            <a class="_1OhGeD" href="/u/a203a1fc243f" target="_blank" rel="noopener noreferrer">Quaint_d79b</a>
                        </div>
                        <div class="_1xqkrI"><span>2楼 </span>
                            <time datetime="2019-12-06T03:50:52.000Z">12.06 11:50</time>
                        </div>
                        <div class="_2bDGm4">来了，老弟</div>
                        <div class="_2ti5br">
                            <div class="_3MyyYc">
                            ...
                            <div class="_3g0yKR">
                                <div class="_3d_vFY">
                                    ...
                                    <div style="margin-left: 10px;">
                                        ...
                                        <div class="_1xqkrI">
                                            <time datetime="2019-12-06T03:51:01.000Z">12.06 11:51</time>
                                        </div>
                                    </div>
                                </div>
                                <div class="_2bDGm4">回复你一下，菜🐶，哈哈哈，啦啦啦</div>
                                <div class="_2ti5br">
                                    <div class="_3MyyYc">
